...
const Contact = () => {
    return(
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 md:gap-16 lg:gap-24 p-2 lg:px-[200px]">
            <div className="flex flex-col gap-2">
                <h2 className="font-semibold text-xl text-center sm:text-start lg:text-3xl">Please tell us a little about you</h2>
                <div className="flex flex-col gap-2 my-3">
                    <h6 className="font-semibold text-center text-md sm:text-start">What would you like to contact us about?</h6>
                ...
                <div className="flex justify-center items-center my-3">
                    <CustomButton description="Submit contact"/>
                </div>
            </div>
            <div className="flex flex-col gap-2 justify-center sm:justify-start ">
                <div className="flex flex-col sm:flex-row gap-2 sm:grid sm:grid-cols-2">
                    <h6 className="font-semibold text-center sm:col-span-1 sm:text-start">Reservations:</h6>
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:grid sm:grid-cols-2">
                    <h6 className="font-semibold text-center sm:col-span-1 sm:text-start">For Landlords:</h6>
                    <div className="flex flex-col sm:col-span-1">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:grid sm:grid-cols-2">
                    <h6 className="font-semibold text-center sm:col-span-1 sm:text-start">For Maintenance:</h6>
                    <div className="flex flex-col sm:col-span-1">
